...
pub const GPIO_OFFSET: u8 = 0x90;
const GPIO_MEM_MAPPED_BASE: Addr = MEM_MAPPED_START_ADDR + (GPIO_OFFSET as Addr);
const GPIO_PIN_ADDRS: Addr = 2;

pub const G0CR_ADDR: Addr = gpio_cr_addr(0); // xFE10
pub const G0DR_ADDR: Addr = gpio_dr_addr(0); // xFE11
pub const G1CR_ADDR: Addr = gpio_cr_addr(1); // xFE12
pub const G1DR_ADDR: Addr = gpio_dr_addr(1); // xFE13
pub const G2CR_ADDR: Addr = gpio_cr_addr(2); // xFE14
pub const G2DR_ADDR: Addr = gpio_dr_addr(2); // xFE15
pub const G3CR_ADDR: Addr = gpio_cr_addr(3); // xFE16
pub const G3DR_ADDR: Addr = gpio_dr_addr(3); // xFE17
pub const G4CR_ADDR: Addr = gpio_cr_addr(4); // xFE18
pub const G4DR_ADDR: Addr = gpio_dr_addr(4); // xFE19
pub const G5CR_ADDR: Addr = gpio_cr_addr(5); // xFE1A
pub const G5DR_ADDR: Addr = gpio_dr_addr(5); // xFE1B
pub const G6CR_ADDR: Addr = gpio_cr_addr(6); // xFE1C
pub const G6DR_ADDR: Addr = gpio_dr_addr(6); // xFE1D
pub const G7CR_ADDR: Addr = gpio_cr_addr(7); // xFE1E
pub const G7DR_ADDR: Addr = gpio_dr_addr(7); // xFE1F

pub const G8CR_ADDR: Addr = gpio_cr_addr(8); // xFE20
pub const G8DR_ADDR: Addr = gpio_dr_addr(8); // xFE21
pub const G9CR_ADDR: Addr = gpio_cr_addr(9); // xFE22
pub const G9DR_ADDR: Addr = gpio_dr_addr(9); // xFE23
pub const G10CR_ADDR: Addr = gpio_cr_addr(10); // xFE24
pub const G10DR_ADDR: Addr = gpio_dr_addr(10); // xFE25
pub const G11CR_ADDR: Addr = gpio_cr_addr(11); // xFE26
pub const G11DR_ADDR: Addr = gpio_dr_addr(11); // xFE27
pub const G12CR_ADDR: Addr = gpio_cr_addr(12); // xFE28
pub const G12DR_ADDR: Addr = gpio_dr_addr(12); // xFE29
pub const G13CR_ADDR: Addr = gpio_cr_addr(13); // xFE2A
pub const G13DR_ADDR: Addr = gpio_dr_addr(13); // xFE2B
pub const G14CR_ADDR: Addr = gpio_cr_addr(14); // xFE2C
pub const G14DR_ADDR: Addr = gpio_dr_addr(14); // xFE2D
pub const G15CR_ADDR: Addr = gpio_cr_addr(15); // xFE2E
pub const G15DR_ADDR: Addr = gpio_dr_addr(15); // xFE2F

pub const G16CR_ADDR: Addr = gpio_cr_addr(16); // xFE30
pub const G16DR_ADDR: Addr = gpio_dr_addr(16); // xFE31
pub const G17CR_ADDR: Addr = gpio_cr_addr(17); // xFE32
pub const G17DR_ADDR: Addr = gpio_dr_addr(17); // xFE33
pub const G18CR_ADDR: Addr = gpio_cr_addr(18); // xFE34
pub const G18DR_ADDR: Addr = gpio_dr_addr(18); // xFE35
pub const G19CR_ADDR: Addr = gpio_cr_addr(19); // xFE36
pub const G19DR_ADDR: Addr = gpio_dr_addr(19); // xFE37
pub const G20CR_ADDR: Addr = gpio_cr_addr(20); // xFE38
pub const G20DR_ADDR: Addr = gpio_dr_addr(20); // xFE39
pub const G21CR_ADDR: Addr = gpio_cr_addr(21); // xFE3A
pub const G21DR_ADDR: Addr = gpio_dr_addr(21); // xFE3B
pub const G22CR_ADDR: Addr = gpio_cr_addr(22); // xFE3C
pub const G22DR_ADDR: Addr = gpio_dr_addr(22); // xFE3D
pub const G23CR_ADDR: Addr = gpio_cr_addr(23); // xFE3E
pub const G23DR_ADDR: Addr = gpio_dr_addr(23); // xFE3F
...
pub const G3_INT_VEC: u8 = 0xB3;
pub const G4_INT_VEC: u8 = 0xB4;
pub const G5_INT_VEC: u8 = 0xB5;
pub const G6_INT_VEC: u8 = 0xB6;
pub const G7_INT_VEC: u8 = 0xB7;
pub const G8_INT_VEC: u8 = 0xB8;
pub const G9_INT_VEC: u8 = 0xB9;
pub const G10_INT_VEC: u8 = 0xBA;
pub const G11_INT_VEC: u8 = 0xBB;
pub const G12_INT_VEC: u8 = 0xBC;
pub const G13_INT_VEC: u8 = 0xBD;
pub const G14_INT_VEC: u8 = 0xBE;
pub const G15_INT_VEC: u8 = 0xBF;
pub const G16_INT_VEC: u8 = 0xC0;
pub const G17_INT_VEC: u8 = 0xC1;
pub const G18_INT_VEC: u8 = 0xC2;
pub const G19_INT_VEC: u8 = 0xC3;
pub const G20_INT_VEC: u8 = 0xC4;
pub const G21_INT_VEC: u8 = 0xC5;
pub const G22_INT_VEC: u8 = 0xC6;
pub const G23_INT_VEC: u8 = 0xC7;
...
gpio_mem_mapped!(G8, "G8", G8CR, G8DR, G8CR_ADDR, G8DR_ADDR, G8_INT_VEC);
gpio_mem_mapped!(G9, "G9", G9CR, G9DR, G9CR_ADDR, G9DR_ADDR, G9_INT_VEC);
gpio_mem_mapped!(G10, "G10", G10CR, G10DR, G10CR_ADDR, G10DR_ADDR, G10_INT_VEC);
gpio_mem_mapped!(G11, "G11", G11CR, G11DR, G11CR_ADDR, G11DR_ADDR, G11_INT_VEC);
gpio_mem_mapped!(G12, "G12", G12CR, G12DR, G12CR_ADDR, G12DR_ADDR, G12_INT_VEC);
gpio_mem_mapped!(G13, "G13", G13CR, G13DR, G13CR_ADDR, G13DR_ADDR, G13_INT_VEC);
gpio_mem_mapped!(G14, "G14", G14CR, G14DR, G14CR_ADDR, G14DR_ADDR, G14_INT_VEC);
gpio_mem_mapped!(G15, "G15", G15CR, G15DR, G15CR_ADDR, G15DR_ADDR, G15_INT_VEC);

gpio_mem_mapped!(G16, "G16", G16CR, G16DR, G16CR_ADDR, G16DR_ADDR, G16_INT_VEC);
gpio_mem_mapped!(G17, "G17", G17CR, G17DR, G17CR_ADDR, G17DR_ADDR, G17_INT_VEC);
gpio_mem_mapped!(G18, "G18", G18CR, G18DR, G18CR_ADDR, G18DR_ADDR, G18_INT_VEC);
gpio_mem_mapped!(G19, "G19", G19CR, G19DR, G19CR_ADDR, G19DR_ADDR, G19_INT_VEC);
gpio_mem_mapped!(G20, "G20", G20CR, G20DR, G20CR_ADDR, G20DR_ADDR, G20_INT_VEC);
gpio_mem_mapped!(G21, "G21", G21CR, G21DR, G21CR_ADDR, G21DR_ADDR, G21_INT_VEC);
gpio_mem_mapped!(G22, "G22", G22CR, G22DR, G22CR_ADDR, G22DR_ADDR, G22_INT_VEC);
gpio_mem_mapped!(G23, "G23", G23CR, G23DR, G23CR_ADDR, G23DR_ADDR, G23_INT_VEC);
